...
This mechanism has been integrated into Bitcore-Node-Curium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/curiumpay/insight-api-curium#web-socket-api](https://github.com/curiumpay/insight-api-curium#web-socket-api)
* API: [https://github.com/curiumpay/insight-api-curium#instantsend-transactions](https://github.com/curiumpay/insight-api-curium#instantsend-transactions)
...
By default, the Curium Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Curium Core daemon:

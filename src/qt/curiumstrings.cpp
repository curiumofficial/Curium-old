...
QT_TRANSLATE_NOOP("curium-core", ""
"Disable all Curium specific functionality (Masternodes, PrivateSend, "
...
"is wrong Curium Core will not work properly."),
QT_TRANSLATE_NOOP("curium-core", ""
...
"transaction that are not equal 1000 CRU."),
QT_TRANSLATE_NOOP("curium-core", ""
...
QT_TRANSLATE_NOOP("curium-core", "%s - %d confirmations"),
QT_TRANSLATE_NOOP("curium-core", "(%d could be used only on mainnet)"),
QT_TRANSLATE_NOOP("curium-core", "(default: %s)"),
QT_TRANSLATE_NOOP("curium-core", "(default: %u)"),
QT_TRANSLATE_NOOP("curium-core", "(must be %d for mainnet)"),
QT_TRANSLATE_NOOP("curium-core", "-maxmempool must be at least %d MB"),
...
QT_TRANSLATE_NOOP("curium-core", "Append comment to the user agent string"),
QT_TRANSLATE_NOOP("curium-core", "Attempt to recover private keys from a corrupt wallet.dat on startup"),
QT_TRANSLATE_NOOP("curium-core", "Automatic backups disabled"),
QT_TRANSLATE_NOOP("curium-core", "Automatically create Tor hidden service (default: %d)"),
...
QT_TRANSLATE_NOOP("curium-core", "Can't mix: no compatible inputs found!"),
...
QT_TRANSLATE_NOOP("curium-core", "Chain selection options:"),
...
QT_TRANSLATE_NOOP("curium-core", "ERROR! Failed to create automatic backup"),
QT_TRANSLATE_NOOP("curium-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("curium-core", "Enable publish hash transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("curium-core", "Enable publish hash transaction in <address>"),
QT_TRANSLATE_NOOP("curium-core", "Enable publish raw block in <address>"),
QT_TRANSLATE_NOOP("curium-core", "Enable publish raw transaction (locked via InstantSend) in <address>"),
QT_TRANSLATE_NOOP("curium-core", "Enable publish raw transaction in <address>"),
QT_TRANSLATE_NOOP("curium-core", "Enable the client to act as a masternode (0-1, default: %u)"),
QT_TRANSLATE_NOOP("curium-core", "Enable transaction replacement in the memory pool (default: %u)"),
QT_TRANSLATE_NOOP("curium-core", "Entries are full."),
QT_TRANSLATE_NOOP("curium-core", "Entry exceeds maximum size."),
...
QT_TRANSLATE_NOOP("curium-core", "Error loading %s: You can't disable HD on a already existing HD wallet"),
...
QT_TRANSLATE_NOOP("curium-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("curium-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("curium-core", "Failed to create backup %s!"),
QT_TRANSLATE_NOOP("curium-core", "Failed to create backup, error: %s"),
QT_TRANSLATE_NOOP("curium-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("curium-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("curium-core", "Failed to load fulfilled requests cache from"),
QT_TRANSLATE_NOOP("curium-core", "Failed to load governance cache from"),
QT_TRANSLATE_NOOP("curium-core", "Failed to load masternode cache from"),
QT_TRANSLATE_NOOP("curium-core", "Failed to load masternode payments cache from"),
QT_TRANSLATE_NOOP("curium-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("curium-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("curium-core", "Imports blocks from external blk000??.dat file on startup"),
...
QT_TRANSLATE_NOOP("curium-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("curium-core", "Keep N CRU anonymized (default: %u)"),
QT_TRANSLATE_NOOP("curium-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("curium-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
QT_TRANSLATE_NOOP("curium-core", "Keypool ran out, please call keypoolrefill first"),
...
QT_TRANSLATE_NOOP("curium-core", "Loading banlist..."),
QT_TRANSLATE_NOOP("curium-core", "Loading block index..."),
QT_TRANSLATE_NOOP("curium-core", "Loading fulfilled requests cache..."),
QT_TRANSLATE_NOOP("curium-core", "Loading governance cache..."),
...
QT_TRANSLATE_NOOP("curium-core", "Location of the auth cookie (default: data dir)"),
...
QT_TRANSLATE_NOOP("curium-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("curium-core", "Masternode cache is empty, skipping payments and governance cache..."),
...
QT_TRANSLATE_NOOP("curium-core", "Minimum bytes per sigop in transactions we relay and mine (default: %u)"),
QT_TRANSLATE_NOOP("curium-core", "Missing input transaction information."),
QT_TRANSLATE_NOOP("curium-core", "Mixing in progress..."),
QT_TRANSLATE_NOOP("curium-core", "Mnemonic passphrase is too long, must be at most 256 characters"),
...
QT_TRANSLATE_NOOP("curium-core", "No errors detected."),
...
QT_TRANSLATE_NOOP("curium-core", "Not enough funds to anonymize."),
QT_TRANSLATE_NOOP("curium-core", "Not in the Masternode list."),
QT_TRANSLATE_NOOP("curium-core", "Number of automatic wallet backups (default: %u)"),
...
QT_TRANSLATE_NOOP("curium-core", "Port: %d"),
QT_TRANSLATE_NOOP("curium-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("curium-core", "Print version and exit"),
...
QT_TRANSLATE_NOOP("curium-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("curium-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("curium-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("curium-core", "RPC server options:"),
QT_TRANSLATE_NOOP("curium-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("curium-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("curium-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("curium-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
...
QT_TRANSLATE_NOOP("curium-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("curium-core", "Synchroning blockchain..."),
...
QT_TRANSLATE_NOOP("curium-core", "Synchronizing governance objects..."),
QT_TRANSLATE_NOOP("curium-core", "Synchronizing masternode payments..."),
QT_TRANSLATE_NOOP("curium-core", "Synchronizing masternodes..."),
QT_TRANSLATE_NOOP("curium-core", "The transaction amount is too small to pay the fee"),
...
QT_TRANSLATE_NOOP("curium-core", "Too many %f denominations, removing."),
QT_TRANSLATE_NOOP("curium-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("curium-core", "Tor control port to use if onion listening enabled (default: %s)"),
...
QT_TRANSLATE_NOOP("curium-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("curium-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("curium-core", "Unknown response."),
QT_TRANSLATE_NOOP("curium-core", "Unknown state: id = %u"),
QT_TRANSLATE_NOOP("curium-core", "Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("curium-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("curium-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("curium-core", "Upgrade wallet to latest format on startup"),
...
QT_TRANSLATE_NOOP("curium-core", "Use the test chain"),
QT_TRANSLATE_NOOP("curium-core", "User Agent comment (%s) contains unsafe characters."),
...
QT_TRANSLATE_NOOP("curium-core", "Very low number of keys left: %d"),
...
QT_TRANSLATE_NOOP("curium-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("curium-core", "Wasn't able to create wallet backup folder %s!"),
QT_TRANSLATE_NOOP("curium-core", "Whether to operate in a blocks only mode (default: %u)"),
...
QT_TRANSLATE_NOOP("curium-core", "ZeroMQ notification options:"),
QT_TRANSLATE_NOOP("curium-core", "no mixing available."),
QT_TRANSLATE_NOOP("curium-core", "see debug.log for details."),

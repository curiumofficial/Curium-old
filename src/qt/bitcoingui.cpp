    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Curium") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Curium"), this);
    aboutAction->setStatusTip(tr("Show information about Curium"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Curium client"));
...
{
    QString strTitle = tr("Curium"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Curium address or malformed URI parameters."),

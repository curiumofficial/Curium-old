    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CRU-light"), QVariant("light"));
    ui->theme->addItem(QString("CRU-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("CRU-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CRU-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CRU-traditional"), QVariant("trad"));

...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizeCurium, OptionsModel::AnonymizeCuriumAmount);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Curium."), QMessageBox::Ok);

    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Curium Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Curium Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  curium-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Curium in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CRU, 0.1 CRU, 1 CRU and 10 CRU -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://curiumpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://curiumpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Curium Core is shutting down...") + "<br /><br />" +

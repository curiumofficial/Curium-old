...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CuriumNetwork") type = CuriumNetwork;
    if(strType == "CuriumNetworkVariable") type = CuriumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CuriumNetwork) s = "CuriumNetwork";
    if(type == CuriumNetworkVariable) s = "CuriumNetworkVariable";

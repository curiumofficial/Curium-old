 ...
 *
 *   // network
 *   CCuriumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.curium.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCuriumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: CuriumNetwork
// //   -- signature requirements : Key1(User)
// class CCuriumNetworkVariable : public CGovernanceObject
// {
// private:

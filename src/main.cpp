...
uint256 hashGenesisBlock("0x000006325e41f0e8420e190a088760e2a0b056fa90e3dcee87f93de771b034fb"); //mainnet

static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Curium: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 10 * 30; // Curium: 1 day
static const int64 nTargetSpacing = 1 * 60; // Curium: 1 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckVotes) const
{
    ...
    // Curium: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Curium: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        hashGenesisBlock = uint256("0x000006325e41f0e8420e190a088760e2a0b056fa90e3dcee87f93de771b034fb");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043384710fa689ad5023690c80f3a49c8f13f8d45b8c8ab357c96de079fac46bd8996b10f4d4604fa08dce601aac4997abcedf92f1fabc21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1515774889;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2568091;
        ...
        assert(block.hashMerkleRoot == uint256("0x5fbd6ce409ff6d08701971bcd7fe2b47ba21e1c08a9287785db8d4089687198c"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CuriumMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static CuriumMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        LogPrintf("Running CuriumMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&CuriumMiner, pwallet));
}

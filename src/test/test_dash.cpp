...
#define BOOST_TEST_MODULE Curium Test Suite

#include "test_curium.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_curium_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

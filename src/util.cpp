...
const char * const BITCOIN_CONF_FILENAME = "curium.conf";
const char * const BITCOIN_PID_FILENAME = "curiumd.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "curium" is a composite category enabling all Curium-related debug output
            if(ptrCategory->count(string("curium"))) {
